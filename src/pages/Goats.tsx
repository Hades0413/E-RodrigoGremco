...
const iconos = {
  "Magaly la firme": (
    <svg viewBox="0 0 24 24" className="iconGoats">
  ...
  return (
    <div className={`card ${esLider ? 'card-lider' : ''}`}>
      <div className="imageContainer">
        <img loading="lazy" src={imagen} alt={nombre} className="image" />
      </div>
...
const Goats: React.FC = () => {
  const colaboradores: ColaboradorProps[] = [
    ...
    { nombre: "HADES0413", apodo: "🐐 Beeeeeee...!!!", rol: "Desarrollador Full Stack", email: "hades0413@goat.com", imagen: goatMiguel },
